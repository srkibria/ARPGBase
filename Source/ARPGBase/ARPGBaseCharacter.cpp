...
AARPGBaseCharacter::AARPGBaseCharacter()
{
	...
	Faction = CreateDefaultSubobject<UAFactionComponent>(TEXT("Faction Component"));
...
void AARPGBaseCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AARPGBaseCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AARPGBaseCharacter::Look);

	}

}

void AARPGBaseCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AARPGBaseCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
